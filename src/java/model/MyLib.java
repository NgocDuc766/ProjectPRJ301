...
//        MyLib m = new MyLib();
//        ScheduleDAO u = new ScheduleDAO();
//        List<ScheduleDTO> lst = u.getScheduleById("HE171957");
//        
//        System.out.println(lst.get(0).getDate().equals(convertStringtoDate("2023-10-19")));
//    }
