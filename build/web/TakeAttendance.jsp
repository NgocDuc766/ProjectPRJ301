    ...
    <body>
        <jsp:include page="header.jsp"></jsp:include>
            <div class="w-95 w-md-75 w-lg-60 w-xl-55 mx-auto mb-6 text-center">
                <h2 class="display-18 display-md-16 display-lg-14 mb-0 mt-5">Take attendance in ${requestScope.lst[0].classId} </h2>
        </div>
        <form method="post" action="confirmTeacher?scheduleId=${requestScope.lst[0].scheduleId}">
                ...
                <tbody>
                    ...
                    <c:forEach items="${requestScope.lst}" var="s">
                        <tr class="h-100" style="height: 70px;">
                            ...
                            <td>
                                <input type="checkbox" name="selectedStudents" value="${s.id}" checked />
                            </td>
                        </tr>
            ...
            <input class="btn btn-warning mx-auto d-block" type="submit" name="submit" value="Save">
        </form>
